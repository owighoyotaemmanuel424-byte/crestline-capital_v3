import { anyApi, type DefaultFunctionArgs, type FunctionReference } from "convex/server";
...
type Ref<T extends "query" | "mutation", A extends DefaultFunctionArgs, R> = FunctionReference<T, "public", A, R>;
